...
def bi_report_read(report: BiReport) -> BiReportRead:
    ...
    return BiReportRead(
        ...
        analysis_scope=chart.get("analysis_scope", "kol"),
        brand_analytics=chart.get("brand_analytics", {}),
        kol_analytics=chart.get("kol_analytics", {}),
        data_availability=chart.get("data_availability", {}),
