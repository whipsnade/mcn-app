...
def _pi_rollout_config_compatible(config: object) -> bool:
    ...
    try:
        ...
        # Historical config JSON may still contain the removed profile mapping;
        # it is never part of the public immutable Run Snapshot projection.
